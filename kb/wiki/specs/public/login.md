...
整張卡片唯一的一點顏色是字標結尾那個 accent 色的句點 —— 其餘全是 Zinc。
（卡片上緣原本還有一條 sky accent 細線，2026-08-29 使用者判定不需要，拿掉了。）
