...
- ~~c6 只守新違規，存量沒有覆蓋~~ → 2026-08-29 補上 gate A12。**這個缺口的形狀值得記住**：
  ...
  「✅ 已接」。~~目前 c2 / c3 / c7 / c8 都還是這個狀態。~~ → **2026-08-30 補上 A13（c7）/
  A14（c8）/ A15（c2）/ A16（c3）**（commit `6d717404`），本頁最上方的表格自那時起就寫著
  「雙層」。**這句話在本頁裡多活了七天，而它正上方的表格說的是相反的事** ——
  一頁文件裡的兩個地方對同一件事給出相反的答案時，**讀者不會發現，他只會讀到其中一個**。
  2026-09-06 由 api-2 席發現，發現的方式是照著它去找工作：這句話讓人以為還有一個
  缺口要補，而那個缺口七天前就補完了。**過期的「還沒做」比過期的「已完成」更貴** ——
  後者頂多讓人漏做一件事，前者讓人真的動手重做一遍。
