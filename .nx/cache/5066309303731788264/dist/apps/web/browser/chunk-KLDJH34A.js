...
// apps/web/src/app/features/parent/pages/grades/grades.component.ts
var GradesComponent = class _GradesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GradesComponent, selectors: [["app-grades"]], inputs: { page: [1, "page"] }, decls: 5, vars: 1, consts: [[1, "p-4"], [1, "text-2xl", "font-bold", "mb-4"], [1, "text-zinc-500"]], template: function GradesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(4, "Parent grades view coming soon...");
      \u0275\u0275domElementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(GradesComponent, [{
    ...
    <div class="p-4">
      ...
      <p class="text-zinc-500">Parent grades view coming soon...</p>
    </div>
  ` }]
  }], null, { page: [{ type: Input, args: [{ isSignal: true, alias: "page", required: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GradesComponent, { className: "GradesComponent", filePath: "apps/web/src/app/features/parent/pages/grades/grades.component.ts", lineNumber: 16 });
})();
export {
  GradesComponent
};
//# sourceMappingURL=chunk-KLDJH34A.js.map
